...
scheme = orion.init_scheme("../orion/configs/mlp.yml")
trainloader, testloader = get_mnist_datasets(data_dir="../orion/data", batch_size=1)
net = models.MLP()

# Train model (optional)
# device = "cuda" if torch.cuda.is_available() else "cpu"
# train_on_mnist(net, data_dir="../orion/data", epochs=1, device=device)
...
orion.fit(net, inp, batch_size=32)
